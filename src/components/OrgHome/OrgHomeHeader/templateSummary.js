...
import ConfigTemplatesDetailed from "../../../views/OrgHome/OrgHomeHeader/configTemplatesDetailed";
    ...
    setTemplateList) =>
{
    ...
    if (shard !== '') {
        const url = contextOrg.proxyURL + "https://" + shard + ".meraki.com/api/v0/organizations/" + orgId + "/configTemplates";
        setTimeout(() => {
            fetch(httpReq(url))
                .then(response => {
                    if (response.ok) {
                ...
                .then(data => {
                    ...
                    setNumberOfTemplates(Object.keys(data).length);
                })
                .catch(error => {
                    return error;
                });
    ...
    return(
        <div>
            <Paper
                ...
                variant="outlined">
                <h3 style={{paddingLeft: 15, paddingRight: 20, fontSize: 30, marginTop: 12}}>Templates</h3>

                <h1 style={{fontSize: 50}}>{numberOfTemplates}</h1>
            </Paper>
            ...
            <Dialog
                ...
                <DialogContent dividers={scroll === 'paper'}>
                    <DialogContentText
                        ...
                        <ConfigTemplatesDetailed orgId={props.orgId} templatesList={templateList}/>
                    </DialogContentText>
                </DialogContent>
