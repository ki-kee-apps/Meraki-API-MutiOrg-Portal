    ...
    useEffect(function () {
        ...
        props.devices.forEach(deviceEntry => {
            props.status.forEach(statusEntry => {
                if(deviceEntry.model.substr(0, 2) === "MR" &&
        ...
        <div>
            <Paper
                ...
                <div style={{paddingLeft: 10, paddingRight: 10}}>
                    <h3 style={{fontSize: 25, marginTop: 12}}>WiFi</h3>
            ...
            <Dialog
                ...
                scroll={scroll}>
                <DialogTitle >Wireless Access Points</DialogTitle>
...
export default WirelessSummary;