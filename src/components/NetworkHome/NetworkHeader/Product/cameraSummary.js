...
import CameraDetailed from "../../../../views/NetworkHome/NetworkHeader/Product/cameraDetailed";

const CameraSummary = (props) => {
    ...
    useEffect(function () {
        ...
        props.devices.forEach(deviceEntry => {
            props.status.forEach(statusEntry => {
                if(deviceEntry.model.substr(0, 2) === "MV" &&
        ...
        <div>
            <Paper
                ...
                <div style={{paddingLeft: 10, paddingRight: 10}}>
                    <h3 style={{fontSize: 25, marginTop: 12}}>Camera</h3>
            ...
            <Dialog
                ...
                <DialogContent dividers={scroll === 'paper'}>
                    <CameraDetailed orgId={props.orgId} deviceList={deviceList} />
                </DialogContent>
